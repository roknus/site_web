<?php
	...
	while($data = $request->fetch()){
		$message .='<li><table onclick="start_chat(\''.$data["membre.id"].'\',\''.$data["login"].'\')"><tr><td><img src="img/'.$data["image_profil"].'.'.$data["type"].'" width="40" height="40"/></td><td><span class="user_name"><strong>'.$data["login"].'</strong></span></td></tr></table></li>';
	}
	echo $message;